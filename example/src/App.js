...
export const App = () => {
  ...
  return (<div className={classnames('app', `acss-theme-${theme}`, 'acss-background-primary')}>
    <Header theme={theme}/>
    ...
    <Grid>
      ...
      <Panel heading="This is Panel header" theme={theme}>
        ...
        <p>Sir Joseph John Thomson (18 December 1856 – 30 August 1940) was an English physicist and Nobel laureate
